                ...
                >
                  <a href={`/${locale}/producto/${producto.slug}`} className="relative h-48 overflow-hidden cursor-pointer group">
                    <div className="absolute inset-0 bg-gray-900">
                      <Image src={producto.imagen} alt={translatedName} fill className="object-cover transition-transform duration-500 group-hover:scale-110" unoptimized={producto.imagen.startsWith('http')} />
                    </div>
                  ...
                  <div className="p-6 flex flex-col grow">
                    ...
                    <div className="space-y-3 mt-auto">
                      ...
                      <a href={`/${locale}/producto/${producto.slug}`} className="block text-center text-orange-600 hover:text-orange-800 font-black text-sm py-2 hover:underline transition-colors">
                        {t('viewDetails')} →
                      </a>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-800 font-bold text-sm leading-relaxed">Avenida Insurgentes Sur, Nº933, Int 102, Piso 1, Colonia Nápoles, Alcaldía Benito Juárez, C.P, 03810, CDMX</p>
            </div>
            <div className="text-center">
              <p className="text-orange-500 font-black text-lg mb-2">{contactT('info.email')}</p>
              <a href="mailto:informacion@bitrixa.com.mx" className="text-gray-800 font-bold hover:text-orange-600 transition-colors">informacion@bitrixa.com.mx</a>
            </div>
            <div className="text-center">
              <p className="text-orange-500 font-black text-lg mb-2">{contactT('info.phone')}</p>
              <a href="tel:+5215556824394" className="text-gray-800 font-bold hover:text-orange-600 transition-colors">+52 1 55 5682 4394</a>
            </div>
          </div>
